...
from googlecloudsdk.appengine.lib.external.api import appinfo_errors
from googlecloudsdk.appengine.lib.external.api import appinfo_includes
from googlecloudsdk.appengine.lib.external.api import croninfo
from googlecloudsdk.appengine.lib.external.api import dispatchinfo
from googlecloudsdk.appengine.lib.external.api import dosinfo
from googlecloudsdk.appengine.lib.external.api import queueinfo
...
class ModuleYamlInfo(_YamlInfo):
  ...
  def UpdateManagedVMConfig(self):
  ...
  def __init__(self, files, project, version=None, check_version=True):
    ...
    for f in files:
      if os.path.isfile(f):
        ...
        self.__Error(
            'Argument [%s] is not a valid deployable file.', f)
