...
from googlecloudsdk.third_party.apis.pubsub.v1beta2 import pubsub_v1beta2_client as cli
from googlecloudsdk.third_party.apis.pubsub.v1beta2 import pubsub_v1beta2_messages
...
class Pubsub(base.Group):
  ...
  def Filter(self, context, args):
    ...
    context['pubsub_msgs'] = pubsub_v1beta2_messages
    context['pubsub'] = cli.PubsubV1beta2(url=(pubsub_url or ''),
