...
class UpdateAlpha(UpdateGA):
  ...
  def Args(parser):
    ...
    enable_caching.detailed_help = """\
        If true, responses to GET requests will be cached, subject to space
        availability and to the control of any cache-control headers in the
        response, as specified in RFC 7234.
        """
  ...
  def Modify(self, args, existing):
    ...
    if args.enable_caching:
      replacement.enableCaching = {
          'true': True, 'false': False}[args.enable_caching]
