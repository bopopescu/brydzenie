...
class ComputeInstanceGroupManagersSetAutoHealingPolicyRequest(_messages.Message):
  """A ComputeInstanceGroupManagersSetAutoHealingPolicyRequest object.
...
class InstanceGroupManager(_messages.Message):
  ...
  Fields:
    ...
    region: [Output Only] URL of the region where the instance group manager
      resides (for regional resources).
    selfLink: [Output Only] Server-defined URL for this managed instance
      group.
    targetPools: The URLs of all TargetPool resources to which new instances
      in the instanceGroup field are added. Updating the target pool values
...
class InstanceGroupManagerActionsSummary(_messages.Message):
  ...
  Fields:
    ...
    none: [Output Only] The number of instances in the managed instance group
      that currently have no scheduled actions.
...
class InstanceGroupManagerAutoHealingPolicy(_messages.Message):
  ...
  Fields:
    actionType: The action to perform when an instance becomes unhealthy.
      ...
      this managed instance group. RESTART performs a soft restart on an
      instance. If the instance cannot restart softly, the instance performs a
      hard restart.
  ...
  class ActionTypeValueValuesEnum(_messages.Enum):
    ...
    values are RECREATE or RESTART. RECREATE replaces an unhealthy instance
    with a new instance that is based on the instance template for this
    managed instance group. RESTART performs a soft restart on an instance. If
    the instance cannot restart softly, the instance performs a hard restart.
...
class ManagedInstance(_messages.Message):
  ...
  Fields:
    ...
    id: The unique identifier for this resource (empty when instance does not
      exist).
