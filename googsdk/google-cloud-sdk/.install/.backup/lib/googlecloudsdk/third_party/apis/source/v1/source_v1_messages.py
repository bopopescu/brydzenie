...
class Alias(_messages.Message):
  ...
  class KindValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      SPECIAL: SPECIAL is used for repository-specific specially interpreted
        names, such as the Perforce "HEAD" alias. Other examples are Mercurial
        "tip" aliases or the Mercurial "." and Git "HEAD" aliases, which both
        mean the currently checked out revision.
    """
    ANY = 0
    FIXED = 1
    MOVABLE = 2
...
class MergeInfo(_messages.Message):
  """MergeInfo holds information needed while resolving
  [merges][google.devtools.source.v1.Merge], and
  [refreshes][google.devtools.source.v1.RefreshWorkspace] that involve
  conflicts.
...
class Repo(_messages.Message):
  ...
  Fields:
    ...
    projectNumber: Temporarily provide the project number to ease conversion
      of existing clients to this API. Will be removed after initial
      conversion.
...
class SourceProjectsCloneRepoRequest(_messages.Message):
  ...
  Enums:
    ExternalVcsValueValuesEnum: The version control system of the repo, if
      known. If left unspecified, it will be determined heuristically.
  ...
  Fields:
    ...
    external_vcs: The version control system of the repo, if known. If left
      unspecified, it will be determined heuristically.
  ...
  class ExternalVcsValueValuesEnum(_messages.Enum):
    ...
    it will be determined heuristically.
...
class SourceProjectsReposGetRequest(_messages.Message):
  ...
  Fields:
    projectId: The ID of the project.
    repoName: The name of the repo. Leave empty for the default repo.
    signature: Signature generated from GenerateSignature that will be
      verified to enable access to a repo without user credentials.
    uid: A server-assigned, globally unique identifier.
  """
