    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          'Create': base_api.ApiMethodInfo(
              ...
              ordered_params=[u'projectId'],
              path_params=[u'projectId'],
              query_params=[u'webDriver_androidDevice_androidModelId', u'webDriver_androidDevice_androidVersionId', u'webDriver_androidDevice_locale', u'webDriver_androidDevice_orientation', u'webDriver_browserId', u'webDriver_endpoint', u'webDriver_id', u'webDriver_linuxMachine_versionId', u'webDriver_projectId', u'webDriver_vmDetails_creationTime', u'webDriver_vmDetails_deviceDetails_connectionInfo_adbPort', u'webDriver_vmDetails_deviceDetails_connectionInfo_ipAddress', u'webDriver_vmDetails_deviceDetails_connectionInfo_sshPort', u'webDriver_vmDetails_deviceDetails_connectionInfo_vncPassword', u'webDriver_vmDetails_deviceDetails_connectionInfo_vncPort', u'webDriver_vmDetails_deviceDetails_gceInstanceDetails_name', u'webDriver_vmDetails_deviceDetails_gceInstanceDetails_projectId', u'webDriver_vmDetails_deviceDetails_gceInstanceDetails_zone', u'webDriver_vmDetails_state', u'webDriver_vmDetails_stateDetails_errorDetails', u'webDriver_vmDetails_stateDetails_progressDetails', u'webDriver_windowsMachine_versionId'],
