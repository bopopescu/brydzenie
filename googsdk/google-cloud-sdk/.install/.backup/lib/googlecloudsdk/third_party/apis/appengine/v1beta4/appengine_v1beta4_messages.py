...
class Application(_messages.Message):
  ...
  Fields:
    ...
    location: The location from which the application will be run. Choices are
      "us" for United States and "eu" for European Union. Application
      instances will run out of data centers in the chosen location and all of
      the application's End User Content will be stored at rest in the chosen
...
class OperationMetadata(_messages.Message):
  ...
  Fields:
    ...
    operationType: The type of the operation. Example: "create_version".
      @OutputOnly
  ...
  operationType = _messages.StringField(3)
...
class Version(_messages.Message):
  ...
  env = _messages.StringField(7)
  envVariables = _messages.MessageField('EnvVariablesValue', 8)
  errorHandlers = _messages.MessageField('ErrorHandler', 9, repeated=True)
  handlers = _messages.MessageField('UrlMap', 10, repeated=True)
  healthCheck = _messages.MessageField('HealthCheck', 11)
  id = _messages.StringField(12)
  inboundServices = _messages.EnumField('InboundServicesValueListEntryValuesEnum', 13, repeated=True)
  instanceClass = _messages.StringField(14)
  libraries = _messages.MessageField('Library', 15, repeated=True)
  manualScaling = _messages.MessageField('ManualScaling', 16)
  name = _messages.StringField(17)
  network = _messages.MessageField('Network', 18)
  nobuildFilesRegex = _messages.StringField(19)
  resources = _messages.MessageField('Resources', 20)
  runtime = _messages.StringField(21)
  threadsafe = _messages.BooleanField(22)
  vm = _messages.BooleanField(23)
