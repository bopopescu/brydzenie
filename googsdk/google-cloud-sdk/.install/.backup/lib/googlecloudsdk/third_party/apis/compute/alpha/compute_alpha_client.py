...
If an empty request body is given, clears the deprecation status instead.
  ...
  class InstanceGroupManagersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'SetAutoHealingPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'compute.instanceGroupManagers.setAutoHealingPolicy',
              ordered_params=[u'project', u'zone', u'instanceGroupManager'],
              path_params=[u'instanceGroupManager', u'project', u'zone'],
              query_params=[],
              ...
              request_type_name=u'ComputeInstanceGroupManagersSetAutoHealingPolicyRequest',
              response_type_name=u'Operation',
              supports_download=False,
          ),
    ...
    def SetAutoHealingPolicy(self, request, global_params=None):
      ...
      Args:
        request: (ComputeInstanceGroupManagersSetAutoHealingPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
