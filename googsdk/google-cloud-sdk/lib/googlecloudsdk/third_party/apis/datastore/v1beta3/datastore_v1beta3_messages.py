...
class AllocateIdsRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.AllocateIds][google.d
  atastore.v1beta3.Datastore.AllocateIds].
...
class AllocateIdsResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.AllocateIds][google.
  datastore.v1beta3.Datastore.AllocateIds].
...
class BeginTransactionRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.BeginTransaction][goo
  gle.datastore.v1beta3.Datastore.BeginTransaction].
...
class BeginTransactionResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.BeginTransaction][go
  ogle.datastore.v1beta3.Datastore.BeginTransaction].
...
class CommitRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.Commit][google.datast
  ore.v1beta3.Datastore.Commit].
  ...
  Fields:
    ...
    transaction: The transaction identifier, returned by a call to [google.dat
      astore.v1beta3.Datastore.BeginTransaction][google.datastore.v1beta3.Data
      store.BeginTransaction]. Must be set when mode is `TRANSACTIONAL`.
  """
...
class CommitResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.Commit][google.datas
  tore.v1beta3.Datastore.Commit].
...
class ExportMetadata(_messages.Message):
  ...
  Fields:
    ...
    destination: Location for the export metadata and data files.  This will
      be the same value as the [google.datastore.v1beta3.ExportRequest.destina
      tion][google.datastore.v1beta3.ExportRequest.destination] field. Actual
      files will be nested deeper than this.  The final output location is
      provided in [google.datastore.v1beta3.ExportResponse.data_location][goog
      le.datastore.v1beta3.ExportResponse.data_location].
...
class ExportRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.DatastoreAdmin.Export][google.d
  atastore.v1beta3.DatastoreAdmin.Export].
  ...
  Fields:
    ...
    destination: Location for the export metadata and data files.  Specified
      ...
      The final data location will be provided in the [google.datastore.v1beta
      3.ExportResponse.data_location][google.datastore.v1beta3.ExportResponse.
      data_location] field.  That value should be used for subsequent Import
      Operations.  By nesting the data files deeper, the same destination can
      be used in multiple Export Operations without conflict.
...
class ExportResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.DatastoreAdmin.Export][google.
  datastore.v1beta3.DatastoreAdmin.Export].

  Fields:
    dataLocation: Location of the output files. This can be used to begin an
      import into Cloud Datastore (this Project or another Project).  See [goo
      gle.datastore.v1beta3.ImportRequest.data_location][google.datastore.v1be
      ta3.ImportRequest.data_location].  Only present if the Operation
      completed successfully.  This location will be nested deeper than the
      initial [google.datastore.v1beta3.ExportRequest.destination][google.data
      store.v1beta3.ExportRequest.destination] in order to support multiple
      Exports to the same destination without conflict.
  """
...
class GqlQuery(_messages.Message):
  ...
  Messages:
    NamedBindingsValue: For each non-reserved named binding site in the query
      ...
      necessarily the inverse. Key must match regex `[A-Za-z_$][A-Za-
      z_$0-9]*`, must not match regex `__.*__`, and must not be `""`.
...
class ImportRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.DatastoreAdmin.Import][google.d
  atastore.v1beta3.DatastoreAdmin.Import].
  ...
  Fields:
    dataLocation: The full resource name of the external storage location.
      ...
      name/objects/object-path.  See [google.datastore.v1beta3.ExportResponse.
      data_location][google.datastore.v1beta3.ExportResponse.data_location]
    databaseId: Database ID against which to make the request. Unset indicates
      the default database. Not currently supported.
...
class ListIndexesResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.DatastoreAdmin.ListIndexes][go
  ogle.datastore.v1beta3.DatastoreAdmin.ListIndexes].
...
class LookupIndexRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.DatastoreAdmin.LookupIndex][goo
  gle.datastore.v1beta3.DatastoreAdmin.LookupIndex].
...
class LookupRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.Lookup][google.datast
  ore.v1beta3.Datastore.Lookup].
...
class LookupResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.Lookup][google.datas
  tore.v1beta3.Datastore.Lookup].
...
class RollbackRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.Rollback][google.data
  store.v1beta3.Datastore.Rollback].
...
class RollbackResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.Rollback][google.dat
  astore.v1beta3.Datastore.Rollback] (an empty message).
  """



class RunQueryRequest(_messages.Message):
  """The request for [google.datastore.v1beta3.Datastore.RunQuery][google.data
  store.v1beta3.Datastore.RunQuery].
  ...
  Fields:
    ...
    partitionId: Entities are partitioned into subsets, identified by a
      ...
      ID is normalized with the standard default context partition ID, but all
...
class RunQueryResponse(_messages.Message):
  """The response for [google.datastore.v1beta3.Datastore.RunQuery][google.dat
  astore.v1beta3.Datastore.RunQuery].
