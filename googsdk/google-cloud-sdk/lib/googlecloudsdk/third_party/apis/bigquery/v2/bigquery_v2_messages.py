...
class JobConfiguration(_messages.Message):
  ...
  link = _messages.MessageField('JobConfigurationLink', 4)
...
class JobConfigurationLink(_messages.Message):
  ...
  sourceUri = _messages.StringField(3, repeated=True)
...
class JobConfigurationQuery(_messages.Message):
  ...
  priority = _messages.StringField(7)
  query = _messages.StringField(8)
  tableDefinitions = _messages.MessageField('TableDefinitionsValue', 9)
  useQueryCache = _messages.BooleanField(10, default=True)
  userDefinedFunctionResources = _messages.MessageField('UserDefinedFunctionResource', 11, repeated=True)
  writeDisposition = _messages.StringField(12)
...
class JobStatistics2(_messages.Message):
  ...
  cacheHit = _messages.BooleanField(1)
  totalBytesProcessed = _messages.IntegerField(2)
