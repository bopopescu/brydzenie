"""Generated client library for pubsub version v1beta2."""
# NOTE: This file is autogenerated and should not be edited by hand.

from apitools.base.py import base_api
from googlecloudsdk.third_party.apis.pubsub.v1beta2 import pubsub_v1beta2_messages as messages


class PubsubV1beta2(base_api.BaseApiClient):
  """Generated client library for service pubsub version v1beta2."""
  ...
  _USER_AGENT = ''
  _CLIENT_CLASS_NAME = u'PubsubV1beta2'
  ...
  def __init__(self, url='', credentials=None,
    ...
    url = url or u'https://pubsub.googleapis.com/'
    super(PubsubV1beta2, self).__init__(
  ...
  class ProjectsSubscriptionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubsubV1beta2.ProjectsSubscriptionsService, self).__init__(client)
      self._method_configs = {
          'Acknowledge': base_api.ApiMethodInfo(
              ...
              query_params=[],
              relative_path=u'v1beta2/{+subscription}:acknowledge',
          ...
          'Delete': base_api.ApiMethodInfo(
              ...
              path_params=[u'subscription'],
              query_params=[],
              relative_path=u'v1beta2/{+subscription}',
              request_field='',
          ...
          'List': base_api.ApiMethodInfo(
              ...
              relative_path=u'v1beta2/{+project}/subscriptions',
              request_field='',
          ...
          'ModifyAckDeadline': base_api.ApiMethodInfo(
              ...
              path_params=[u'subscription'],
              query_params=[],
              relative_path=u'v1beta2/{+subscription}:modifyAckDeadline',
          ...
          'ModifyPushConfig': base_api.ApiMethodInfo(
              ...
              path_params=[u'subscription'],
              query_params=[],
              relative_path=u'v1beta2/{+subscription}:modifyPushConfig',
          ...
          'Pull': base_api.ApiMethodInfo(
              ...
              path_params=[u'subscription'],
              query_params=[],
              relative_path=u'v1beta2/{+subscription}:pull',
...
existing policy.
  ...
  class ProjectsTopicsSubscriptionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubsubV1beta2.ProjectsTopicsSubscriptionsService, self).__init__(client)
      self._method_configs = {
          'List': base_api.ApiMethodInfo(
              http_method=u'GET',
              ...
              path_params=[u'topic'],
              query_params=[u'pageSize', u'pageToken'],
              relative_path=u'v1beta2/{+topic}/subscriptions',
              request_field='',
  ...
  class ProjectsTopicsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubsubV1beta2.ProjectsTopicsService, self).__init__(client)
      self._method_configs = {
          'Create': base_api.ApiMethodInfo(
              http_method=u'PUT',
          ...
          'List': base_api.ApiMethodInfo(
              ...
              path_params=[u'project'],
              query_params=[u'pageSize', u'pageToken'],
              relative_path=u'v1beta2/{+project}/topics',
              request_field='',
          ...
          'Publish': base_api.ApiMethodInfo(
              ...
              path_params=[u'topic'],
              query_params=[],
              relative_path=u'v1beta2/{+topic}:publish',
...
existing policy.
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubsubV1beta2.ProjectsService, self).__init__(client)
      self._method_configs = {
          }
