"""Generated message classes for pubsub version v1beta2.
...
class ModifyAckDeadlineRequest(_messages.Message):
  ...
  Fields:
    ...
    ackId: The acknowledgment ID. Either this or ack_ids must be populated,
      but not both.
    ackIds: List of acknowledgment IDs.
  """

  ackDeadlineSeconds = _messages.IntegerField(1, variant=_messages.Variant.INT32)
  ackId = _messages.StringField(2)
  ackIds = _messages.StringField(3, repeated=True)
...
class PushConfig(_messages.Message):
  ...
  class AttributesValue(_messages.Message):
    ...
    valid version, even if the subscription was created without this
...
class Subscription(_messages.Message):
  ...
  Fields:
    ackDeadlineSeconds: This value is the maximum time after a subscriber
      ...
      the corresponding ack_id.  For push delivery, this value is also used to
