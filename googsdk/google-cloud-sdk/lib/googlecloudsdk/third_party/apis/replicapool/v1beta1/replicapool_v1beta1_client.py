...
from googlecloudsdk.third_party.apis.replicapool.v1beta1 import replicapool_v1beta1_messages as messages
...
class ReplicapoolV1beta1(base_api.BaseApiClient):
  ...
  _SCOPES = [u'https://www.googleapis.com/auth/cloud-platform', u'https://www.googleapis.com/auth/cloud-platform.read-only', u'https://www.googleapis.com/auth/ndev.cloudman', u'https://www.googleapis.com/auth/ndev.cloudman.readonly', u'https://www.googleapis.com/auth/replicapool', u'https://www.googleapis.com/auth/replicapool.readonly']
  _VERSION = u'v1beta1'
