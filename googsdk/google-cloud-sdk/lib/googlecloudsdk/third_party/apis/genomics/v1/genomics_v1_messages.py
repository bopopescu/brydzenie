...
class GenomicsOperationsListRequest(_messages.Message):
  ...
  Fields:
    filter: A string for filtering [Operations][google.longrunning.Operation].
      The following filter fields are supported&#58;  * projectId&#58;
      Required. Corresponds to   [OperationMetadata.projectId][google.genomics
      .v1.OperationMetadata.project_id]. * createTime&#58; The time this job
...
class GenomicsVariantsPatchRequest(_messages.Message):
  ...
  Fields:
    updateMask: An optional mask specifying which fields to update. At this
      ...
      [info][google.genomics.v1.Variant.info]. Acceptable values are "names"
...
class Operation(_messages.Message):
  ...
  Messages:
    MetadataValue: An
      [OperationMetadata][google.genomics.v1.OperationMetadata] object. This
      will always be returned with the
      [Operation][google.longrunning.Operation].
    ResponseValue: If importing
      [ReadGroupSets][google.genomics.v1.ReadGroupSet], an [ImportReadGroupSet
      sResponse][google.genomics.v1.ImportReadGroupSetsResponse] is returned.
      If importing [Variants][google.genomics.v1.Variant], an
  ...
  Fields:
    ...
    metadata: An [OperationMetadata][google.genomics.v1.OperationMetadata]
      object. This will always be returned with the
      [Operation][google.longrunning.Operation].
    name: The server-assigned name, which is only unique within the same
      service that originally returns it. For example&#58; `operations
      /CJHU7Oi_ChDrveSpBRjfuL-qzoWAgEw`
    response: If importing [ReadGroupSets][google.genomics.v1.ReadGroupSet],
      an [ImportReadGroupSetsResponse][google.genomics.v1.ImportReadGroupSetsR
      esponse] is returned. If importing
  ...
  class MetadataValue(_messages.Message):
    """An [OperationMetadata][google.genomics.v1.OperationMetadata] object.
  ...
  class ResponseValue(_messages.Message):
    """If importing [ReadGroupSets][google.genomics.v1.ReadGroupSet], an [Impo
    rtReadGroupSetsResponse][google.genomics.v1.ImportReadGroupSetsResponse]
...
class Read(_messages.Message):
  ...
  The following pseudocode demonstrates one way of doing this:      out = ""
...
class Status(_messages.Message):
  ...
  additional error codes if needed.  The error message should be a developer-
  facing English message that helps developers *understand* and *resolve* the
  error. If a localized user-facing error message is needed, put the localized
  message in the error details or localize it in the client. The optional
  error details may contain arbitrary information about the error. There is a
  predefined set of error detail types in the package `google.rpc` which can
  be used for common error conditions.  # Language mapping  The `Status`
  ...
  the client,     it may embed the `Status` in the normal response to indicate
  ...
  response, one for     each error sub-response.  - Asynchronous operations.
  If an API call embeds asynchronous operation     results in its response,
  the status of those operations should be     represented directly using the
