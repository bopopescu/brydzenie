...
Implements [GlobalAllianceApi.searchCallSets](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/variantmethods.avdl#L178).
  ...
  class DatasetsService(base_api.BaseApiService):
    ...
    def GetIamPolicy(self, request, global_params=None):
      """GetIamPolicy method for the datasets service.
    ...
    def SetIamPolicy(self, request, global_params=None):
      """SetIamPolicy method for the datasets service.
    ...
    def TestIamPermissions(self, request, global_params=None):
      """TestIamPermissions method for the datasets service.
  ...
  class OperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Delete': base_api.ApiMethodInfo(
              http_method=u'DELETE',
              method_id=u'genomics.operations.delete',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[],
              relative_path=u'v1/{+name}',
              request_field='',
              request_type_name=u'GenomicsOperationsDeleteRequest',
              response_type_name=u'Empty',
              supports_download=False,
          ),
          'Get': base_api.ApiMethodInfo(
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (GenomicsOperationsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
