...
class TestingProjectsWebdriverCreateRequest(_messages.Message):
  ...
  Enums:
    WebDriverVmDetailsStateValueValuesEnum: State of the device. @OutputOnly

  Fields:
    projectId: The GCP project under which to create the WebDriver
      environment.
    webDriver_androidDevice_androidModelId: The id of the Android device to be
      used. Use the EnvironmentDiscoveryService to get supported options.
      Required
    webDriver_androidDevice_androidVersionId: The id of the Android OS version
      to be used. Use the EnvironmentDiscoveryService to get supported
      options. Required
    webDriver_androidDevice_locale: The locale the test device used for
      testing. Use the EnvironmentDiscoveryService to get supported options.
      Required
    webDriver_androidDevice_orientation: How the device is oriented during the
      test. Use the EnvironmentDiscoveryService to get supported options.
      Required
    webDriver_browserId: The id of the browser to be used. Use the
      EnvironmentDiscoveryService to get supported values. Required
    webDriver_endpoint: The endpoint in host:port format where the target
      running the specified browser accepts WebDriver protocol commands.
      @OutputOnly
    webDriver_id: Unique id set by the system. @OutputOnly
    webDriver_linuxMachine_versionId: The version id of the Linux OS to be
      used. Use the EnvironmentDiscoveryService to get supported options.
    webDriver_projectId: The GCE project for this WebDriver test environment.
      @OutputOnly
    webDriver_vmDetails_creationTime: The time this device was initially
      created. @OutputOnly
    webDriver_vmDetails_deviceDetails_connectionInfo_adbPort: Port for ADB
      (e.g. 5555) NOT user-specified
    webDriver_vmDetails_deviceDetails_connectionInfo_ipAddress: IP address of
      the device. NOT user-specified
    webDriver_vmDetails_deviceDetails_connectionInfo_sshPort: Port for SSH
      (e.g. 22) NOT user-specified
    webDriver_vmDetails_deviceDetails_connectionInfo_vncPassword: Password for
      VNC NOT user-specified
    webDriver_vmDetails_deviceDetails_connectionInfo_vncPort: Port for VNC
      (e.g. 6444) NOT user-specified
    webDriver_vmDetails_deviceDetails_gceInstanceDetails_name: Desired
      instance name of the device. May be user-specified. If not, the backend
      will choose a name.
    webDriver_vmDetails_deviceDetails_gceInstanceDetails_projectId: The GCE
      project that contains the instance backing this device. If user-
      specified, must be the same as the project_id in the
      CreateDeviceRequest.
    webDriver_vmDetails_deviceDetails_gceInstanceDetails_zone: Desired GCE
      zone for the device user-specified
    webDriver_vmDetails_state: State of the device. @OutputOnly
    webDriver_vmDetails_stateDetails_errorDetails: If the DeviceState is
      ERROR, then this string may contain human-readable details about the
      error.
    webDriver_vmDetails_stateDetails_progressDetails: A human-readable,
      detailed description of the device's status. For example: "Starting
      Device\n Device Ready".  During the device's lifespan data may be
      appended to the progress.
    webDriver_windowsMachine_versionId: The version id of the Windows OS to be
      used. Use the EnvironmentDiscoveryService to get supported options.
  """

  class WebDriverVmDetailsStateValueValuesEnum(_messages.Enum):
  ...
  projectId = _messages.StringField(1, required=True)
  webDriver_androidDevice_androidModelId = _messages.StringField(2)
  webDriver_androidDevice_androidVersionId = _messages.StringField(3)
  webDriver_androidDevice_locale = _messages.StringField(4)
  webDriver_androidDevice_orientation = _messages.StringField(5)
  webDriver_browserId = _messages.StringField(6)
  webDriver_endpoint = _messages.StringField(7)
  webDriver_id = _messages.StringField(8)
  webDriver_linuxMachine_versionId = _messages.StringField(9)
  webDriver_projectId = _messages.StringField(10)
  webDriver_vmDetails_creationTime = _messages.StringField(11)
  webDriver_vmDetails_deviceDetails_connectionInfo_adbPort = _messages.IntegerField(12, variant=_messages.Variant.INT32)
  webDriver_vmDetails_deviceDetails_connectionInfo_ipAddress = _messages.StringField(13)
  webDriver_vmDetails_deviceDetails_connectionInfo_sshPort = _messages.IntegerField(14, variant=_messages.Variant.INT32)
  webDriver_vmDetails_deviceDetails_connectionInfo_vncPassword = _messages.StringField(15)
  webDriver_vmDetails_deviceDetails_connectionInfo_vncPort = _messages.IntegerField(16, variant=_messages.Variant.INT32)
  webDriver_vmDetails_deviceDetails_gceInstanceDetails_name = _messages.StringField(17)
  webDriver_vmDetails_deviceDetails_gceInstanceDetails_projectId = _messages.StringField(18)
  webDriver_vmDetails_deviceDetails_gceInstanceDetails_zone = _messages.StringField(19)
  webDriver_vmDetails_state = _messages.EnumField('WebDriverVmDetailsStateValueValuesEnum', 20)
  webDriver_vmDetails_stateDetails_errorDetails = _messages.StringField(21)
  webDriver_vmDetails_stateDetails_progressDetails = _messages.StringField(22)
  webDriver_windowsMachine_versionId = _messages.StringField(23)
...
class WebDriver(_messages.Message):
  ...
  vmDetails = _messages.MessageField('VMDetails', 7)
  windowsMachine = _messages.MessageField('WindowsMachine', 8)
