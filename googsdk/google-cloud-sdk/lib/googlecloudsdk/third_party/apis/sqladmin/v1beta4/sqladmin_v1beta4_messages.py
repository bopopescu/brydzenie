...
class SqlSslCertsSignRequest(_messages.Message):
  """A SqlSslCertsSignRequest object.

  Fields:
    instance: Cloud SQL instance ID. This does not include the project ID.
    project: Project ID of the Cloud SQL project.
    sslCertsSignRequest: A SslCertsSignRequest resource to be passed as the
      request body.
  """

  instance = _messages.StringField(1, required=True)
  project = _messages.StringField(2, required=True)
  sslCertsSignRequest = _messages.MessageField('SslCertsSignRequest', 3)
...
class SslCertsSignRequest(_messages.Message):
