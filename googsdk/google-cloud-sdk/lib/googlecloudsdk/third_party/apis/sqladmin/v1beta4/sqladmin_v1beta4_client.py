  ...
  class SslCertsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Sign': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'sql.sslCerts.sign',
              ordered_params=[u'project', u'instance'],
              path_params=[u'instance', u'project'],
              query_params=[],
              relative_path=u'projects/{project}/instances/{instance}/certSign',
              request_field=u'sslCertsSignRequest',
              request_type_name=u'SqlSslCertsSignRequest',
              response_type_name=u'SslCert',
              supports_download=False,
          ),
          }
    ...
    def Sign(self, request, global_params=None):
      """Generates a short-lived X509 certificate containing the provided public key and signed by a private key specific to the target instance. Users may use the certificate to authenticate as themselves when connecting to the database.

      Args:
        request: (SqlSslCertsSignRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (SslCert) The response message.
      """
      config = self.GetMethodConfig('Sign')
      return self._RunMethod(
          config, request, global_params=global_params)
