"""Generated message classes for clouduseraccounts version staging_alpha.
...
class Binding(_messages.Message):
  ...
  Fields:
    members: Format of member entries: 1. allUsers Matches any requesting
      ...
      using an email address. For example alice@gmail.com, joe@example.com  4.
      serviceAccount:{emailid} An service account email.  5. group:{emailid} A
      google group with an email address. For example auth-ti-cloud@google.com
      6. domain:{domain} A Google Apps domain name. For example google.com,
      example.com
...
class Policy(_messages.Message):
  ...
  VMs, etc.    # Policy structure  A `Policy` consists of a list of bindings.
  A `Binding` binds a set of members to a role, where the members include user
  ...
  examples:  ``` { "bindings": [ { "role": "roles/owner", "members": [
