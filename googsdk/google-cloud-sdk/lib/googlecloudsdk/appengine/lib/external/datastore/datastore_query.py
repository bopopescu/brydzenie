...
from googlecloudsdk.appengine.lib.external.api.search import geo_util
...
from googlecloudsdk.appengine.lib.external.datastore import datastore_rpc
...
def _extract_property_names(entity, value_map, prefix=''):
  ...
  for prop in entity.property_list():
    ...
    if new_prefix in value_map:
      ...
      # If at least one of the requested properties is in the embedded entity
