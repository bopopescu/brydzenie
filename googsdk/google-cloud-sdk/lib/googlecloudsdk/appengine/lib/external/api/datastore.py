...
from googlecloudsdk.appengine.lib.external.api import capabilities
...
from googlecloudsdk.appengine.lib.external.datastore import datastore_query
    ...
    for is_indexed, prop_list in (
      ...
      for prop in prop_list:
        ...
        try:
          ...
          # This piece of code should not be here, but it has to. Blame
