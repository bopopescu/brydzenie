...
def UpdateContextEndpointEntries(context, http, api_client_default='v1'):
  ...
  clouduseraccounts_client = (
      known_clouduseraccounts_apis.get(
          api_client,
          clouduseraccounts_alpha_client.ClouduseraccountsAlpha))

  clouduseraccounts = clouduseraccounts_client(url=clouduseraccounts_url,
