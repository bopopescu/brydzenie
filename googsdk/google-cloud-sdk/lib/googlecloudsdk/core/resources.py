...
_API_CLIENT_MAP = {
    'autoscaler': [
        ClientDef('googlecloudsdk.third_party.apis.autoscaler.v1beta2.AutoscalerV1beta2')
    ],
    'bigquery': [
    ...
    'compute': [
        ...
        ClientDef('googlecloudsdk.third_party.apis.compute.alpha.ComputeAlpha', True),
        ClientDef('googlecloudsdk.third_party.apis.compute.beta.ComputeBeta', True),
    ],
    'clouduseraccounts': [
    ...
    'datastore': [
        ClientDef('googlecloudsdk.third_party.apis.datastore.v1beta3.DatastoreV1')
    ],
    'dns': [
        ClientDef('googlecloudsdk.third_party.apis.dns.v1.DnsV1')
    ],
    'genomics': [
        ClientDef('googlecloudsdk.third_party.apis.genomics.v1beta2.GenomicsV1beta2')
    ],
    'loasproject_pa': [
        ClientDef('googlecloudsdk.third_party.apis.loasproject_pa.v1.LoasprojectPaV1')
    ],
    'logging': [
        ClientDef('googlecloudsdk.third_party.apis.logging.v1beta3.LoggingV1beta3')
    ],
    'manager': [
        ClientDef('googlecloudsdk.third_party.apis.manager.v1beta2.ManagerV1beta2')
    ],
    'replicapool': [
    ...
    'sql': [
        ClientDef('googlecloudsdk.third_party.apis.sqladmin.v1beta3.SqladminV1beta3')],
    'storage': [
